...
(function (factory, global) {
    ...
    function run(promise) {
        if (promise._status === PromiseStatus.PENDING) {
            return;
        }

        var value = promise._value;
        var callbacks = promise._status === PromiseStatus.FULLFILLED
    ...
    function resolve(promise, data) {
        ...
        promise._status = PromiseStatus.FULLFILLED;
        promise._value = data;
    ...
    function reject(promise, reason) {
        ...
        promise._status = PromiseStatus.REJECTED;
